...
## Project Structure
    ...
    ├── testapiautostoryboa_71427  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_71427`
...
2. Clone this repo and `cd testapiautostoryboa_71427`
